...
ActiveRecord::Schema.define(version: 2019_12_22_081907) do
  ...
  create_table "books_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
